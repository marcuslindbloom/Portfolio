...
import { ANIMATIONS, DEFAULTS, DIRECTIONS, ELEMENT_IDS, EVENTS, INPUT, STYLES, TIMING } from "../constants";
import { kbm } from "../kaboomCtx";

export const displayDialogue = (text: string, onDisplayEnd: () => void): void =>  {
    const dialogueUI = document.getElementById(ELEMENT_IDS.TEXTBOX_CONTAINER) as HTMLElement;
    ...
    const closeBtn = document.getElementById(ELEMENT_IDS.CLOSE_BUTTON) as HTMLElement;
